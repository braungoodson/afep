afep.factory('coursesFactory',function(){
  ...
  var _courses = {
    "3": {
      "course_area": "CS",
      "course_desc": "Algorithmic, game-theoretic and logical foundations of multi-agent systems, including distributed optimization and problem solving, non-cooperative game theory, learning and teaching, communication, social choice, mechanism design, auctions, negotiation, coalitional game theory, logics of knowledge and belief, collaborative plans and social systems.",
      "course_title": "Multi-Agent Systems",
      "course_name": "CS 285",
      "terms": {
        "2011_fall": {
          "instructors": [
    ...
    "6": {
      "course_area": "CS",
      "course_desc": "Interplay between computation and economics. Topics in electronic commerce, computational social choice, computational mechanism design, peer production, prediction markets and reputation systems. Readings in AI, theoretical CS, multi-agent systems, economic theory, and operations research. The topic for Spring 2014 is Matching and Market Design.",
      "course_title": "Topics at the Interface between Computer  Science and Economics",
      "course_name": "CS 286r",
      "terms": {
        "2011_fall": {
          "instructors": [
    ...
    "15": {
      "course_area": "CS",
      "course_desc": "Current topics and research methods in HCI.  Course involves  discussion of primary literature, lectures, and research-oriented  project. The focus is on developing skills to conduct novel research  involving design and evaluation of interactive systems.",
      "course_title": "Topics in User Interfaces",
      "course_name": "CS 279r",
      "terms": {
        "2011_fall": {
          "instructors": [
    ...
    "18": {
      "course_area": "CS",
      "course_desc": "Students in this experimental capstone course will work in teams to solve a series of hard problems-based cases related to cyberlaw and intellectual property.",
      "course_title": "Cyberlaw and Intellectual Property: Advanced Problem Solving Workshop",
      "course_name": "CS 201",
      "terms": {
        "2012_spring": {
          "instructors": [
          ...
          "meet_times": [
            {
              ...
              "startTime": "15:20:00",
              "endTime": "16:50:00",
              "building": "LAW - Caspersen Wasserstein Building",
              "room": "3018"
            },
            {
              "weekDay": "Tu",
    ...
    "27": {
      "course_area": "CS",
      "course_desc": "Important algorithms and their real life applications.  Topics include combinatorics, string matching, wavelets, FFT, computational algebra number theory and geometry, randomized algorithms, search engines, page rankings, maximal flows, error correcting codes, cryptography, parallel algorithms.",
      "course_title": "Efficient Algorithms",
      "course_name": "CS 226r",
      "terms": {
        "2011_fall": {
          "instructors": [],
    ...
    "33": {
      "course_area": "AC",
      "course_desc": "This course will provide the background and an extensive set of examples showing how computational methods are applied to modern design of materials with desired functionality. The methods will span multiple length and time scales, including molecular dynamics simulations, first-principles approaches, stochastic methods for optimization and sampling, and continuum elasticity theory. Examples will include problems in electronic and photonic devices, materials for energy conversion, storage, and environmental protection, and those related to mechanical strength of materials. ",
      "course_title": "Computational Design of Materials",
      "course_name": "AC 275",
      "terms": {
        "2012_fall": {
          "instructors": [],
    ...
    "37": {
      "course_area": "CS",
      "course_desc": "Seminar course exploring recent research in programming languages. Topics vary from year to year. Students read and present research papers, undertake a research project.",
    ...
    "44": {
      "course_area": "CS",
      "course_desc": "Widely applicable mathematical tools for computer science, including topics from logic, set theory, combinatorics, number theory, probability theory, and graph theory. Practice in reasoning formally and proving theorems.",
    ...
    "47": {
      "course_area": "CS",
      "course_desc": "Algorithms to guarantee privacy and authenticity of data during communication and computation.  Proofs of security based on precise definitions and assumptions. Topics may include one-way functions, private-key and public-key encryption, digital signatures, pseudorandom generators, zero-knowledge proofs, fully homomorphic encryption, and the role of cryptography in network and systems security.",
    ...
    "52": {
      "course_area": "CS",
      "course_desc": "Covers topics related to algorithms for big data, especially related to networks. Themes include compression, cryptography, coding, and information retrieval related to the World Wide Web. Requires a major final project.",
      "course_title": "Algorithms at the Ends of the Wire",
      "course_name": "CS 222",
      "terms": {
        "2011_fall": {
          "instructors": [
    ...
    "58": {
      "course_area": "CS",
      "course_desc": "Implementation of efficient interpreters and compilers for programming languages. Associated algorithms and pragmatic issues. Emphasizes practical applications including those outside of programming languages proper. Also shows relationships to programming-language theory and design. Participants build a working compiler including lexical analysis, parsing, type checking, code generation, and register allocation. Exposure to run-time issues and optimization.",
    ...
    "62": {
      "course_area": "CS",
      "course_desc": "Introduction and survey of virtual machines. This class will cover the various applications of virtual machine systems and their design choices, ranging from process-level abstraction to both high-level language machine architecture (such as DotNet and Java) and system-level virtualization (like VMware systems). Class readings will also include the study of co-designed virtual machine systems.",
      "course_title": "Virtual Machines",
      "course_name": "CS 253r",
      "terms": {
        "2011_fall": {
          "instructors": [],
    ...
    "66": {
      "course_area": "CS",
      "course_desc": "The contents and course requirements are similar to those of Computer Science 144r, with the exception that students enrolled in Computer Science 244r are expected to do substantial system implementation and perform graduate-level work. ",
      "course_title": "Networks Design Projects",
      "course_name": "CS 244r",
      "terms": {
        "2012_spring": {
          "instructors": [
    ...
    "91": {
      "course_area": "CS",
      "course_desc": "This is a project-based course emphasizing designing, building, testing, maintaining and modifying software for scientific computing. Students will work in groups on a number of projects, ranging from small data-transformation utilities to large-scale systems. Students will learn to use a variety of tools and languages, as well as various techniques for organizing teams. Most important, students will learn to fit tools and approaches to the problem being solved. ",
      "course_title": "Systems Development for Computational Science",
      "course_name": "CS 207",
      "terms": {
        "2012_spring": {
          "instructors": [
        ...
        "2013_spring": {
          ...
          "meet_times": [
            ...
            },
            {
              ...
              "startTime": "13:00:00",
              "endTime": "14:30:00",
              "building": "Farkas Hall (New College Theater)",
              "room": "103"
            },
            {
              "weekDay": "M",
    ...
    "141": {
      "course_area": "CS",
      "course_desc": "Probabilistic techniques and tools for the design and analysis of algorithms. Designed for all first-year graduate students in all areas. ",
      "course_title": "Probabilistic Analysis and Algorithms",
      "course_name": "CS 223",
      "terms": {
        "2011_fall": {
          "instructors": [
    ...
    "142": {
      "course_area": "CS",
      "course_desc": "Seminar course exploring recent research in computer architecture. Topics vary from year to year and will include subjects such as multi-core architectures, energy-efficient computing, reliable computing, and the interactions of these issues with system software. Students read and present research papers, undertake a research project.",
    ...
    "144": {
      "course_area": "CS",
      "course_desc": "Advanced course in computer graphics focusing on image rendering and processing. Topics include: light transport, efficient rendering, image based rendering, texture processing, interactive image processing.",
      "course_title": "Rendering and Image Processing in Computer Graphics",
      "course_name": "CS 278",
      "terms": {
        "2011_spring": {
          "instructors": [
    ...
    "148": {
      ...
      "course_desc": "Introduction to the intellectual enterprises of computer science and the art of programming. This course teaches students how to think algorithmically and solve problems efficiently. Topics include abstraction, algorithms, data structures, encapsulation, resource management, security, software engineering, and web development. Languages include C, PHP, and JavaScript plus SQL, CSS, and HTML. Problem sets inspired by real-world domains of biology, cryptography, finance, forensics, and gaming. Designed for concentrators and non-concentrators alike, with or without prior programming experience.",
      "course_title": "Introduction to Computer Science I",
      "course_name": "CS 50 (Letter Grade)",
      "terms": {
        "2013_fall": {
          "instructors": [
            "David Malan"
    ...
    "159": {
      "course_area": "CS",
      "course_desc": "Design and analysis of efficient algorithms and data structures. Algorithm design methods, graph algorithms, approximation algorithms, and randomized algorithms are covered.",
    ...
    "165": {
      "course_area": "CS",
      "course_desc": "Cooperative design and development of advanced network-based systems with both technology and business considerations. Students will work in 2 person teams. Student work will include reading assignments, homework sets, a project proposal, and project reports and presentations. At the end of the class, all teams will defend their approaches and results in front of the class and invited guests. ",
      "course_title": "Networks Design Projects",
      "course_name": "CS 144r",
      "terms": {
        "2012_spring": {
    ...
    "172": {
      "course_area": "CS",
      "course_desc": "Covers the fundamental concepts of database and information management. Data models: relational, object-oriented, and other; implementation techniques of database management systems, such as indexing structures, concurrency control, recovery, and query processing; management of unstructured data; terabyte-scale databases.",
    ...
    "183": {
      "course_area": "CS",
      "course_desc": "A quantitative theory of the resources needed for computing and the impediments to efficient computation. The models of computation considered include ones that are finite or infinite, deterministic, randomized, quantum or nondeterministic, discrete or algebraic, sequential or parallel.",
    ...
    "193": {
      "course_area": "CS",
      "course_desc": "Reviews research in programming language-based security mechanisms. Topics include compiler and run-time techniques for enforcing policies; type and proof systems for expressing policies; and static analyses for establishing policies.",
      "course_title": "Topics in Language-Based Security",
      "course_name": "CS 255r",
      "terms": {
        "2011_spring": {
          "instructors": [
    ...
    "209": {
      "course_area": "CS",
      "course_desc": "General introduction to the theory of computation, teaching how to reason precisely about computation and prove mathematical theorems about its capabilities and limitations. Finite automata, Turing machines, formal languages, computability, uncomputability, computational complexity, and the P vs. NP question.",
    ...
    "210": {
      "course_area": "CS",
      "course_desc": "A quantitative approach to operating system design and evaluation. Discussion of recent research including extensible operating system architectures, distributed systems, and performance analysis. Overview of research techniques and methodology.",
      "course_title": "Research Topics in Operating Systems",
      "course_name": "CS 261",
      "terms": {
        "2011_fall": {
          "instructors": [
    ...
    "218": {
      "course_area": "CS",
      "course_desc": "Recent advances in wireless communications and sensor networks. Wireless networking, routing, standards including 802.11, Bluetooth, and 802.15.4. Embedded OS, programming tools, applications, and security. Students read research papers and undertake a research project.",
    ...
    "220": {
      "course_area": "CS",
      "course_desc": "An introduction to the most important discoveries and intellectual paradigms in computer science, designed for students with little or no previous background.  Explores problem-solving using high and low-level programming languages; presents an integrated view of computer systems, from switching circuits up through compilers and GUI design.  Examines theoretical and practical limitations related to unsolvable and intractable computational problems, and the social and ethical dilemmas presented by such issues as software unreliability and invasions of privacy.",
      "course_title": "Great Ideas in Computer Science",
      "course_name": "CS 1",
      "terms": {
        "2011_spring": {
          "instructors": [
    ...
    "236": {
      "course_area": "CS",
      "course_desc": "The contents and course requirements are similar to those of Computer Science 148, with the exception that students enrolled in Computer Science 248 are expected to do a substantial design project and paper discussions on advanced topics.  ",
      "course_title": "Advanced Design of VLSI Circuits and Systems",
      "course_name": "CS 248",
      "terms": {
        "2011_spring": {
          "instructors": [
    ...
    "242": {
      "course_area": "CS",
      "course_desc": "Topics on the design and analysis of algorithms, processes, and systems related to crowds and social networks. Readings in AI, theoretical CS, machine learning, social science theory, economic theory, and operations research. ",
      "course_title": "Topics on Computation in Networks and Crowds",
      "course_name": "CS 284r",
      "terms": {
        "2013_fall": {
          "instructors": [
    ...
    "243": {
      "course_area": "CS",
      "course_desc": "Cooperative design, development, and testing of a sizable and realistic computer system. Students work as a group with a client on a real-world open-ended problem, and gain experience in problem definition, software development, and system lifecycle issues, and in the area of application. Students work in groups; both student participation in the classroom and effective group cooperation outside the classroom are stressed.",
      "course_title": "System Design Projects",
      "course_name": "CS 96",
      "terms": {
        "2012_spring": {
          "instructors": [
    ...
    "249": {
      "course_area": "CS",
      "course_desc": "Surveys biologically-inspired approaches to designing distributed systems. Focus is on algorithms, analysis, and programming paradigms.  Topics: swarm intelligence, amorphous computing, immune-inspired systems, synthetic biology.  Discussion of research papers and a research project required.",
      "course_title": "Biologically-Inspired Distributed and Multi-Agent Systems",
      "course_name": "CS 266",
      "terms": {
        "2011_spring": {
          "instructors": [
    ...
    "250": {
      "course_area": "CS",
      "course_desc": "Surveys biologically-inspired approaches to designing distributed systems. Focus is on algorithms, analysis, and programming paradigms.  Topics: swarm intelligence, amorphous computing, immune-inspired systems, synthetic biology.  Discussion of research papers and a research project required.",
      "course_title": "Biologically-inspired Multi-agent Systems",
      "course_name": "CS 289",
      "terms": {
        "2014_spring": {
          "instructors": [
    ...
    "261": {
      "course_area": "CS",
      "course_desc": "An examination of the special problems associated with distributed computing such as partial failure, lack of global knowledge, asynchrony and coordination of time, and protocols that function in the face of these problems. Emphasis on both the theory that grounds thinking about these systems and in the ways to design and build such systems.",
      "course_title": "Introduction to Distributed Computing",
      "course_name": "CS 262",
      "terms": {
        "2011_spring": {
          "instructors": [
    ...
    "273": {
      "course_area": "AC",
      "course_desc": "This course explores the Internet as a central component of modern scientific data processing and computation. We will examine the architecture of the Internet and the models of computation and data with which it is compatible. Through readings and exercises, students will explore the trade-offs of these various models and gain an appreciation for successful Internet-oriented system design for modern, federated, data- and compute-intensive scientific research. Students will complete a team project to develop an Internet-based system for scientific data processing. Python will be used for examples.",
      "course_title": "Data and Computation on the Internet",
      "course_name": "AC 263",
      "terms": {
        "2012_fall": {
          "instructors": [
    ...
    "282": {
      "course_area": "CS",
      "course_desc": "Seminar course discussing readings from research in programming language design and implementation.  This offering will explore unifying abstractions for next-generation programming languages.  Transactions and communication, types and effects, types and logics, modules and classes.",
      "course_title": "Topics in Programming Language Design and Implementation",
      "course_name": "CS 250r",
      "terms": {
        "2011_spring": {
          "instructors": [
    ...
    "291": {
      "course_area": "CS",
      "course_desc": "An introduction to key design principles and techniques for visualizing data. Covers design practices, data and image models, visual perception, interaction principles, visualization tools, and applications. Introduces programming of web-based interactive visualizations.",
      "course_title": "Visualization",
      "course_name": "CS 171",
      "terms": {
        "2011_spring": {
          "instructors": [
    ...
    "299": {
      "course_area": "AC",
      "course_desc": "Supervision of experimental or theoretical research on acceptable applied computation problems and supervision of reading on topics not covered by regular courses of instruction.",
      "course_title": "Special Topics in Applied Computation",
      "course_name": "AC 299r",
      "terms": {
        "2014_spring": {
          "instructors": [
    ...
    "307": {
      "course_area": "CS",
      "course_desc": "Advanced statistical machine learning and probabilistic data analysis. Topics include: Markov chain Monte Carlo, variational inference, Bayesian nonparametrics, text topic modeling, unsupervised learning, dimensionality reduction and visualization. Requires a major final project.",
    ...
    "308": {
      "course_area": "CS",
      "course_desc": "The contents and course requirements are similar to those of Computer Science 146, with the exception that students enrolled in Computer Science 246 are expected to undertake a substantial course project. ",
    ...
    "316": {
      "course_area": "CS",
      "course_desc": "Review of the fundamental structures in modern processor design. Topics include computer organization, memory system design, pipelining, and other techniques to exploit parallelism. Emphasis on a quantitative evaluation of design alternatives and an understanding of timing issues.",
    ...
    "335": {
      "course_area": "CS",
      "course_desc": "Created to support the Sectioning Tool for Labs for CS141.",
      "course_title": "Computing Hardware",
      "course_name": "CS 141 Lab",
      "terms": {
        "2011_fall": {
          "instructors": [],
          "meet_times": []
    ...
    "364": {
      "course_area": "CS",
      "course_desc": "Seminar course exploring recent research in computer vision. Topics vary from year to year, typically including object recognition; activity recognition; and visual surveillance. Students read and present research papers and undertake a research project.",
      "course_title": "Advanced Topics in Computer Vision",
      "course_name": "CS 288r",
      "terms": {
        "2014_spring": {
          "instructors": [
